...
# Data sales team Ponorogo
sales_data = {
    'NAMA_DS': ['MAMAN FIRMANSYAH', 'ARYO ADHITYAS SETYO', 'YETTI FITASARI'],
    'GRADE': ['SPV', 'DS', 'DS'],
    'TARGET': [35, 25, 25],
    'SALES': [4, 11, 1],
    'MINUS_PLUS': [-31, -14, -24],
...
print("SALES PERFORMANCE DATA - PONOROGO AREA")
...
fig.suptitle('ANALISIS KINERJA SALES - AREA PONOROGO\n21 Juli - 20 Agustus', 
...
print("• Review strategi penjualan area Ponorogo")
print("• Evaluasi target yang mungkin tidak realistis")
print("• Pelatihan teknik selling khusus untuk DS")
print("• Monitoring khusus untuk Yetti Fitasari (4% pencapaian)")
print("• Peningkatan performa untuk Maman Firmansyah sebagai SPV")