...
# Data sales team Subang
sales_data = {
    'NAMA_DS': ['BAGAS PERMANA', 'DWI HARI PURNAMA', 'JENAR NURJANI', 'ASEP RAHMAT', 
                'LILI WARNALI', 'RAHMAT HIDAYAT', 'YOGI HERMAWAN', 'AHMAD BUCHORI',
                'NAZAR YAHYA', 'ARDEN ZUHDI', 'MUHAMMAD JAKA NUGRAHA', 'UCI SANUSI',
                'DENI WAHYUDIN', 'MOCHAMAD ALEK LESMANA', 'GINANJAR MAULANA YUSUF',
                'Edi Sunardi'],
    'GRADE': ['SPV', 'DS', 'DS', 'DS', 'DS', 'DS', 'DS', 'DS', 'SPV', 'DS', 'DS', 'DS', 
              'DS', 'DS', 'DS', 'DS'],
    'TARGET': [35, 25, 25, 25, 25, 25, 25, 25, 35, 25, 25, 25, 25, 25, 25, 25],
    'SALES': [0, 4, 34, 27, 23, 33, 7, 3, 0, 13, 23, 29, 24, 8, 3, 0],
    'MINUS_PLUS': [-35, -21, 9, 2, -2, 8, -18, -22, -35, -12, -2, 4, -1, -17, -22, -25],
    'PERSENTASE': [0, 16, 136, 108, 92, 132, 28, 12, 0, 52, 92, 116, 96, 32, 12, 0]
}
...
print("SALES PERFORMANCE DATA - SUBANG AREA")
...
fig.suptitle('ANALISIS KINERJA SALES - AREA SUBANG\n21 Juli - 20 Agustus', 
...
print("Status: PERLU PERBAIKAN - Beberapa performer excellent, tapi banyak yang underperform")

print("\n5. REKOMENDASI:")
print("-" * 50)
print("• Fokus pada 2 SPV dan 2 DS dengan 0% pencapaian")
print("• Coaching intensif untuk 6 DS dengan pencapaian di bawah 50%")
print("• Replikasi best practices dari top performers (JENAR 136%, RAHMAT H. 132%)")
print("• Evaluasi target untuk SPV yang mungkin tidak realistis")
print("• Monitoring khusus untuk DS dengan performa terendah")
print("• Reward untuk 4 DS dengan pencapaian excellent (>100%)")