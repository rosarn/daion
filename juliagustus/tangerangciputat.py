...
# Data input untuk LEGOK CIKASUNGKA
data = {
...
fig.suptitle('ANALISIS PENCAPAIAN SALES TEAM LEGOK CIKASUNGKA\nPeriode: 21 Juli - 20 Agustus', 
...
for i, (target, sales) in enumerate(zip(role_comparison['Target'], role_comparison['Sales'])):
    axes[1, 1].text(i - width/2, target + 1, f'{target}', ha='center', fontweight='bold')
    axes[1, 1].text(i + width/2, sales + 1, f'{sales}', ha='center', fontweight='bold')
...
print("=" * 70)
print("ANALISIS PENCAPAIAN SALES TEAM LEGOK CIKASUNGKA")
...
print("   3. Pelajari strategi dari top performers (3 DS dengan pencapaian >100%)")
print("   4. Review target untuk memastikan realistis dan achievable")
print("   5. Pertimbangkan reward system untuk motivasi tim")
