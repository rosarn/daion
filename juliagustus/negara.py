...
# Data sales team Negara
sales_data = {
    'NAMA_DS': ['Jimmi Kurniawan', 'Heri Susanto', 'Erwin Hadi', 'I Putu Nova Eka Swastika',
                'Mohamad Fauzi', 'Wiji Astuti', 'I Gede Candra Permana Putra Wibawa',
                'Zainus Salim', 'Kristin Prihatini', 'I Gusti Agung Komang Panji Wiryawan',
                'Sayu Putu Puspa Desi Astiti', 'Ahmad Hasibin'],
    'GRADE': ['SPV', 'DS', 'DS', 'DS', 'DS', 'DS', 'SPV', 'DS', 'DS', 'DS', 'DS', 'DS'],
    'TARGET': [35, 25, 25, 25, 25, 25, 35, 25, 25, 25, 25, 25],
    'SALES': [0, 28, 44, 26, 8, 7, 0, 27, 17, 0, 0, 0],
    'MINUS_PLUS': [-35, 3, 19, 1, -17, -18, -35, 2, -8, -25, -25, -25],
    'PERSENTASE': [0, 112, 176, 104, 32, 28, 0, 108, 68, 0, 0, 0]
}
...
print("SALES PERFORMANCE DATA - NEGARA AREA")
...
fig.suptitle('ANALISIS KINERJA SALES - AREA NEGARA\n21 Juli - 20 Agustus', 
...
for index, row in df.iterrows():
    ...
    print(f"{short_name.ljust(20)} ({row['GRADE']}): {row['ACHIEVEMENT_RATE']:6.1f}% - {status}")
...
print("Status: KRITIS - Polaritas tinggi: 5 zero performers vs 4 excellent performers")

print("\n5. REKOMENDASI:")
print("-" * 60)
print("• Fokus pada 2 SPV dan 3 DS dengan 0% pencapaian")
print("• Coaching intensif untuk 2 DS dengan pencapaian rendah (28-32%)")
print("• Replikasi best practices dari excellent performers (Erwin 176%, Heri 112%)")
