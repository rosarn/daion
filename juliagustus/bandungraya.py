...
# Data sales team Bandung Raya
sales_data = {
    'NAMA_DS': ['Robyana', 'Riyadi Wijaya', 'Aep Yudi', 'Roni Herlani', 
                'Angga Saputra', 'Irsyad Abidin', 'Samsudin', 'Dema Ahmad Yanuar'],
    'GRADE': ['SPV', 'DS', 'DS', 'DS', 'DS', 'DS', 'DS', 'DS'],
    'TARGET': [35, 25, 25, 25, 25, 25, 25, 25],
    'SALES': [0, 20, 28, 56, 61, 28, 35, 9],
    'MINUS_PLUS': [-35, -5, 3, 31, 36, 3, 10, -16],
    'PERSENTASE': [0, 80, 112, 224, 244, 112, 140, 36]
}
...
print("SALES PERFORMANCE DATA - BANDUNG RAYA AREA")
...
fig.suptitle('ANALISIS KINERJA SALES - AREA BANDUNG RAYA\n21 Juli - 20 Agustus', 
...
bars3 = ax3.bar(performance_dist.index, performance_dist.values, 
                color=['#FF6B6B', '#FF9F1C', '#F9DC5C', '#4ECDC4', '#2EC4B6', '#1A936F'], 
                alpha=0.8)
...
print(f"Total Excess: {df['SALES'].sum() - df['TARGET'].sum()} unit")
print("Status: EXCELLENT - Tim melebihi target secara keseluruhan!")

print("\n5. REKOMENDASI:")
print("-" * 50)
print("• Fokus pada SPV dengan 0% pencapaian (Robyana)")
print("• Coaching untuk 1 DS dengan pencapaian rendah (Dema - 36%)")
print("• Replikasi best practices dari outstanding performers (Angga 244%, Roni 224%)")
print("• Reward dan recognition untuk seluruh DS dengan performa excellent")
print("• Evaluasi target untuk meningkatkan challenge bagi top performers")
print("• Mentoring program dari top performers ke underperformers")