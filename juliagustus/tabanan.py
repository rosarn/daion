...
# Data sales team Tabanan
sales_data = {
    'NAMA_DS': ['Moh Sadam Putra', 'Vernando Vargas Kahale', 'ketut Artha Suardika', 
                'Mohammad Fa is', 'Anditya Rizki Alfian Adha'],
    'GRADE': ['SPV', 'DS', 'DS', 'DS', 'DS'],
    'TARGET': [35, 25, 25, 25, 25],
    'SALES': [0, 0, 6, 36, 0],  # Asumsi Anditya Rizki sales 0 karena minus 25
    'MINUS_PLUS': [-35, -25, -19, 11, -25],
    'PERSENTASE': [0, 0, 24, 144, 0]
}
...
print("SALES PERFORMANCE DATA - TABANAN AREA")
...
fig.suptitle('ANALISIS KINERJA SALES - AREA TABANAN\n21 Juli - 20 Agustus', 
...
print("Status: SANGAT KRITIS - Hanya 1 performer, 4 orang zero performance")

print("\n5. REKOMENDASI:")
print("-" * 45)
print("• INTERVENSI DARURAT untuk SPV dan 3 DS dengan 0% pencapaian")
print("• Coaching intensif khusus untuk ketut Artha (24%)")
print("• Replikasi best practices dari Mohammad Fa is (144%) ke seluruh tim")
print("• Evaluasi ulang strategi penjualan area Tabanan")
print("• Monitoring ketat progress harian semua anggota")
