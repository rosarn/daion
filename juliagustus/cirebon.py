...
# Data sales team Cirebon
sales_data = {
    'NAMA_DS': ['ACHMADUN', 'MAILAN', 'TRI WAHYONO', 'HARYONO', 'DESI KUSRIYANTI', 
                'ABDUL RAJAB', 'AJIS SAPTORI', 'ASTRI RAHMAWATI', 'TEGUH PRABOWO',
                'SUTAN ALI SOBANA', 'HAFID SANGIDUN', 'SUJA SUDIRJA', 
                'RD UJANG OTAN HARTANTO', 'UNTUNG WIBOWO', 'CUT SALSABILAH SUCIANI',
                'MUHAMAD ALFANI', 'DHANI RAMADON', 'ZULMI RAMADHAN', 'HERU SAPUTRA',
                'RAHMAT GUMILANG', 'RIFFAN MUBAROK'],
    'GRADE': ['SPV', 'DS', 'DS', 'DS', 'DS', 'DS', 'DS', 'DS', 'SPV', 'DS', 'DS', 'DS', 
              'DS', 'SPV', 'DS', 'DS', 'DS', 'DS', 'DS', 'DS', 'DS'],
    'TARGET': [35, 25, 25, 25, 25, 25, 25, 25, 35, 25, 25, 25, 25, 35, 25, 25, 25, 25, 25, 25, 25],
    'SALES': [0, 14, 17, 12, 9, 21, 12, 8, 0, 40, 49, 55, 72, 0, 28, 15, 15, 28, 27, 21, 11],
    'MINUS_PLUS': [-35, -11, -8, -13, -16, -4, -13, -17, -35, 15, 24, 30, 47, -35, 3, -10, -10, 3, 2, -4, -14],
    'PERSENTASE': [0, 56, 68, 48, 36, 84, 48, 32, 0, 160, 196, 220, 288, 0, 112, 60, 60, 112, 108, 84, 44]
}
...
print("SALES PERFORMANCE DATA - CIREBON AREA")
...
fig.suptitle('ANALISIS KINERJA SALES - AREA CIREBON\n21 Juli - 20 Agustus', 
...
print("Status: BAIK - Beberapa performer excellent, tapi ada yang perlu perhatian khusus")

print("\n5. REKOMENDASI:")
print("-" * 50)
print("• Fokus pada 3 SPV dengan 0% pencapaian (ACHMADUN, TEGUH PRABOWO, UNTUNG WIBOWO)")
print("• Coaching untuk DS dengan pencapaian di bawah 50%")
print("• Replikasi best practices dari top performers (RD UJANG, SUJA, HAFID)")
print("• Evaluasi target untuk SPV yang mungkin tidak realistis")
print("• Reward dan recognition untuk DS dengan pencapaian >100%")