...
# Data sales team Denpasar
sales_data = {
    'NAMA_DS': ['SITI NURHAYATI', 'I MADE JULIANTARA', 'NI MADE KARMI', 'PUTU AGUS PRAMANA PUTRA',
    ...
    'GRADE': ['SPV', 'DS', 'DS', 'DS', 'DS', 'DS', 'DS', 'DS', 'SPV', 'DS', 'DS', 'DS',
              'DS', 'DS', 'DS', 'DS', 'SPV', 'DS', 'DS', 'DS', 'DS'],
    'TARGET': [15, 25, 25, 25, 25, 25, 25, 25, 15, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25],
    'SALES': [10, 23, 28, 6, 17, 0, 0, 2, 2, 25, 37, 15, 8, 8, 7, 4, 0, 30, 5, 2, 1],
    'MINUS_PLUS': [-5, -2, 3, -19, -8, -25, -25, -23, -13, 0, 12, -10, -17, -17, -18, -21, -25, 5, -20, -23, -24],
    'PERSENTASE': [67, 92, 112, 24, 68, 0, 0, 8, 13, 100, 148, 60, 32, 32, 28, 16, 0, 120, 20, 8, 4]
}
...
print("SALES PERFORMANCE DATA - DENPASAR AREA")
...
fig.suptitle('ANALISIS KINERJA SALES - AREA DENPASAR\n21 Juli - 20 Agustus', 
...
print("Status: KRITIS - Banyak underperformer, beberapa excellent performer")

print("\n5. REKOMENDASI:")
print("-" * 60)
print("• Fokus pada 3 SPV dan 4 DS dengan 0-8% pencapaian")
print("• Coaching intensif untuk 9 DS dengan pencapaian di bawah 50%")
print("• Replikasi best practices dari excellent performers (I NENGAH 148%, TRIANA 120%)")
