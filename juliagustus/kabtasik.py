...
# Data sales team Kabupaten Tasikmalaya
sales_data = {
    'NAMA_DS': ['Iman Firman', 'Dian Hernanda', 'Trisna Juliansyah', 
                'Abdul Koharudin', 'Dasep Abdul Gopur', 'Rudiansyah Moch Azhar'],
    'GRADE': ['SPV', 'DS', 'DS', 'DS', 'DS', 'DS'],
    'TARGET': [35, 25, 25, 25, 25, 25],
    'SALES': [0, 38, 15, 36, 22, 15],
    'MINUS_PLUS': [-35, 13, -10, 11, -3, -10],
    'PERSENTASE': [0, 152, 60, 144, 88, 60]
}
...
print("SALES PERFORMANCE DATA - KABUPATEN TASIKMALAYA AREA")
...
fig.suptitle('ANALISIS KINERJA SALES - AREA KABUPATEN TASIKMALAYA\n21 Juli - 20 Agustus', 
...
print("Status: BAIK - Dua performer excellent, tapi SPV perlu perhatian khusus")

print("\n5. REKOMENDASI:")
print("-" * 50)
print("• Fokus pada SPV dengan 0% pencapaian (Iman Firman)")
print("• Coaching untuk 2 DS dengan pencapaian 60% (Trisna, Rudiansyah)")
print("• Replikasi best practices dari top performers (Dian 152%, Abdul 144%)")
print("• Evaluasi target untuk SPV yang mungkin tidak realistis")
print("• Dukungan untuk Dasep yang hampir mencapai target (88%)")
print("• Reward untuk DS dengan pencapaian excellent (>100%)")