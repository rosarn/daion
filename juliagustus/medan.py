...
# Data sales team Medan
sales_data = {
    'NAMA_DS': ['IRWAN FAUZI HARAHAP', 'JAMOT MANALU', 'DIAN ADI PUTRA HASIBUAN', 
                'YON SIDEK SAGALA', 'FERI PRATAMA', 'IVAL YOGA SARA',
                'DEDE ZULKARNAIN', 'MUHAMMAD FASHA', 'HOTMAULI SIMAREMARE',
                'RAYMOND H SITANGGANG', 'MHD DANDI PRATAMA', 'NANDA AKBAR'],
    'GRADE': ['SPV', 'DS', 'DS', 'DS', 'DS', 'DS', 'SPV', 'DS', 'DS', 'DS', 'DS', 'DS'],
    'TARGET': [25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25],
    'SALES': [0, 35, 32, 40, 26, 18, 0, 31, 35, 31, 18, 16],
    'MINUS_PLUS': [-25, 10, 7, 15, 1, -7, -25, 6, 10, 6, -7, -9],
    'PERSENTASE': [0, 140, 128, 160, 104, 72, 0, 124, 140, 124, 72, 64]
}
...
print("SALES PERFORMANCE DATA - MEDAN AREA")
...
fig.suptitle('ANALISIS KINERJA SALES - AREA MEDAN\n21 Juli - 20 Agustus', 
...
print("Status: BAIK - Tim hampir mencapai target, excellent performers banyak")

print("\n5. REKOMENDASI:")
print("-" * 50)
print("• Fokus pada 2 SPV dengan 0% pencapaian")
print("• Coaching untuk 2 DS dengan pencapaian 64-72%")
print("• Replikasi best practices dari excellent performers (YON 160%, JAMOT 140%)")
print("• Evaluasi target untuk SPV yang mungkin tidak realistis")
print("• Program mentoring dari top performers")
print("• Reward untuk 7 DS dengan pencapaian excellent (>100%)")