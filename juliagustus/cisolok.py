...
# Data sales team Cisolok
sales_data = {
    'NAMA_DS': ['DEFFAN KAHFI ADHIGUNA', 'GITUS GISMANA', 'MOHAMAD RAMLI', 
                'YULI YULIANA', 'YOGI', 'AGAM MULIA'],
    'GRADE': ['SPV', 'DS', 'DS', 'DS', 'DS', 'DS'],
    'TARGET': [35, 25, 25, 25, 25, 25],
    'SALES': [0, 15, 8, 13, 18, 2],
    'MINUS_PLUS': [-35, -10, -17, -12, -7, -23],
    'PERSENTASE': [0, 60, 32, 52, 72, 8]
}
...
print("SALES PERFORMANCE DATA - CISOLOK AREA")
...
fig.suptitle('ANALISIS KINERJA SALES - AREA CISOLOK\n21 Juli - 20 Agustus', 
...
bins = [0, 20, 50, 80, 100, 150]
labels = ['0-20%', '21-50%', '51-80%', '81-100%', '>100%']
...
bars3 = ax3.bar(performance_dist.index, performance_dist.values, 
                color=['#FF6B6B', '#FF9F1C', '#F9DC5C', '#A8D5BA', '#2EC4B6'], 
                alpha=0.8)
...
print("Status: KRITIS - SPV tidak berkinerja, beberapa DS perlu perbaikan")

print("\n5. REKOMENDASI:")
print("-" * 45)
print("• Fokus pada SPV dengan 0% pencapaian (DEFFAN KAHFI ADHIGUNA)")
print("• Coaching intensif untuk 2 DS dengan pencapaian rendah (AGAM 8%, MOHAMAD 32%)")
print("• Dukungan untuk 2 DS dengan pencapaian menengah (YULI 52%, GITUS 60%)")
print("• Optimalkan performa DS terbaik (YOGI 72%) sebagai motivator")
print("• Evaluasi target untuk SPV yang mungkin tidak realistis")
print("• Program mentoring internal tim")